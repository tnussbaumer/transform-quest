-- ============================================================
-- Fix: Allow re-completion to update answers (no double XP)
-- RUN THIS MANUALLY in the Supabase SQL Editor dashboard.
-- Must be run AFTER all previous migrations (001–008).
-- ============================================================

-- Previously, complete_reading threw 'Already completed today' on
...
BEGIN
  ...
  -- Already completed today — just update the answers, no double XP/streak
  IF v_last_date = v_today THEN
    UPDATE public.completions
    SET answer_1 = p_answer_1, answer_2 = p_answer_2, answer_3 = p_answer_3
