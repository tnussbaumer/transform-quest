...
export function AdminPage() {
  ...
  return (
    <div className="min-h-screen bg-tq-bg text-tq-text">
      {/* Header */}
      <header className="sticky top-0 z-20 bg-tq-bg/90 backdrop-blur-md border-b border-tq-border/50">
        <div className="mx-auto max-w-[640px] px-4">
          <div className="flex items-center gap-3 h-14">
            <button
              onClick={() => navigate('/')}
              className="p-1.5 -ml-1.5 rounded-lg text-tq-text-sec hover:text-tq-text hover:bg-tq-surface transition-colors"
